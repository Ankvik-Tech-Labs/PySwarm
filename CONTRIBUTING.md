...
Welcome to the contributor guide of PySwarm.
...
If you experience bugs or general issues with PySwarm, please have a look
...
You can help improve the documentation of PySwarm by making them more readable
...
3. Clone this copy to your local disk:
   ...
   ```console
   git clone git@github.com:YourLogin/pyswarm.git
   cd pyswarm
   ```
